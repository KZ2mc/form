    ...
    <Base>
      <div className="stripe-blue">
        <div className="content-div px-5 narrow">
          <h1>All About Moving</h1>
          <Post
            ref_link="blog-estimate-move-size"
            img_src="src/img/how-to-estimate-your-move-size.jpg"
          ...
          <Post
            ...
            img_src="src/img/kz2-moving-company-residential-moving.png"
          ...
          <Post
            ref_link=""
            img_src="src/img/preparing-for-moving.jpg"
          ...
          <Post
            ref_link=""
            img_src="src/img/kz2-moving-company-heavy-items-moving.png"
          ...
          <Post
            ...
            img_src="src/img/movers-or-uhaul.jpg"
